...
def create_user(user_id):
    ...
    Applet(id_applet=0, enable=False, user_id=user_id, action_service=settings.SERVICE_NAME[0], action='test', action_logo=settings.MY_IP + 'statics/logo.png', reaction_service=settings.SERVICE_NAME[5], reaction='test', reaction_logo=settings.MY_IP + 'statics/logo.png').save()
    ...
    Applet(id_applet=1, enable=False, user_id=user_id, action_service=settings.SERVICE_NAME[1], action='test', action_logo=settings.MY_IP + 'statics/logo.png', reaction_service=settings.SERVICE_NAME[4], reaction='test', reaction_logo=settings.MY_IP + 'statics/logo.png').save()
    ...
    Applet(id_applet=2, enable=False, user_id=user_id, action_service=settings.SERVICE_NAME[2], action='test', action_logo=settings.MY_IP + 'statics/logo.png', reaction_service=settings.SERVICE_NAME[3], reaction='test', reaction_logo=settings.MY_IP + 'statics/logo.png').save()
    ...
    Applet(id_applet=3, enable=False, user_id=user_id, action_service=settings.SERVICE_NAME[3], action='test', action_logo=settings.MY_IP + 'statics/logo.png', reaction_service=settings.SERVICE_NAME[2], reaction='test', reaction_logo=settings.MY_IP + 'statics/logo.png').save()
    ...
    Applet(id_applet=4, enable=False, user_id=user_id, action_service=settings.SERVICE_NAME[4], action='test', action_logo=settings.MY_IP + 'statics/logo.png', reaction_service=settings.SERVICE_NAME[1], reaction='test', reaction_logo=settings.MY_IP + 'statics/logo.png').save()
    ...
    Applet(id_applet=5, enable=False, user_id=user_id, action_service=settings.SERVICE_NAME[5], action='test', action_logo=settings.MY_IP + 'statics/logo.png', reaction_service=settings.SERVICE_NAME[0], reaction='test', reaction_logo=settings.MY_IP + 'statics/logo.png').save()
